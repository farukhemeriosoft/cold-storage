import{B as e,E as t,F as n,H as r,J as i,L as a,T as o,d as s,e as c}from"./index-BVLw4TQv.js";import{b as l}from"./BarcodeScannerIntegration-COO31Lcg.js";const u={class:`barcode-test-page`},d={class:`flex-1 p-4 sm:p-6 lg:p-8`},f={class:`max-w-4xl mx-auto`},p={class:`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6`},m={class:`test-card`},h={class:`barcode-container`},g={class:`test-info`},_={class:`test-card`},v={class:`barcode-container`},y={class:`test-info`},b={class:`test-card`},x={class:`barcode-container`},S={class:`test-info`},C={class:`test-card`},w={class:`barcode-container`},T={class:`test-info`},E={class:`test-card`},D={class:`barcode-container`},O={class:`test-info`},k={class:`test-card`},A={class:`test-info`},j={class:`mt-8`},M={__name:`BarcodeTestPage`,setup(c){let M=s(),N=o(null),P=o(null),F=o(null),I=o(null),L=o(null),R=o(null),z=()=>{M.back()},B=()=>{R.value&&R.value.openScanner()},V=e=>{console.log(`Scan result:`,e),alert(`Barcode scanned: ${e.code} (${e.format})`)},H=e=>{console.log(`Search action:`,e),alert(`Searching for: ${e.code}`)},U=e=>{console.log(`Create action:`,e),alert(`Creating item with barcode: ${e.code}`)},W=async e=>{try{await navigator.clipboard.writeText(e),alert(`Copied to clipboard: ${e}`)}catch(t){console.error(`Failed to copy:`,t);let n=document.createElement(`textarea`);n.value=e,document.body.appendChild(n),n.select(),document.execCommand(`copy`),document.body.removeChild(n),alert(`Copied to clipboard: ${e}`)}},G=()=>{N.value&&(N.value.innerHTML=`
